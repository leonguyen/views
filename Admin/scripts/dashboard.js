...
// Wait for all assets (including the dynamically loaded AdminLTE scripts) to load before rendering the dashboard.
window.addEventListener('load', () => {

  // -- Helper: Build sidebar menu from JSON dynamically
  ...
  // -- Authentication card example (uncomment for separate login page or modal) --
  /*
