import v from 'voca'; // Import the voca library
...
/*
import StringUtil from './String.js'; // Assuming String.js is in the same directory

const stringProcessor = new StringUtil();

const myText = "  Hello world, this is a TEST string with special characters!@#  ";

console.log("Original:", myText);
console.log("Slugified:", stringProcessor.slugify(myText)); // hello-world-this-is-a-test-string-with-special-characters
console.log("Formatted Filename:", stringProcessor.formatFileName(myText)); // HelloWorldThisIsATestStringWithSpecialCharacters
console.log("First Characters:", stringProcessor.getFirstCharacters(myText)); // Hwtiaswsc
console.log("Replaced:", stringProcessor.replace(myText, "test", "demo")); //  Hello world, this is a demo string with special characters!@#

// Voca.js extensions
console.log("Capitalized:", stringProcessor.capitalize(myText)); // Hello world, this is a test string with special characters!@#
console.log("Title Case:", stringProcessor.titleCase(myText)); // Hello World, This Is A Test String With Special Characters!@#
console.log("Camel Case:", stringProcessor.camelCase("foo bar baz")); // fooBarBaz
console.log("Ends With '!',", stringProcessor.endsWith(myText, '!')); // true
console.log("Truncated:", stringProcessor.truncate(myText, 20)); //   Hello world, thi...
console.log("Centered:", stringProcessor.center("abc", 9, '-')); // ---abc---
console.log("Chopped:", stringProcessor.chop("abcdef", 2)); // ["ab", "cd", "ef"]
console.log("Count 'is':", stringProcessor.countSubstrings(myText, 'is')); // 2
console.log("Escaped HTML:", stringProcessor.escapeHtml("<div>Hello & World</div>")); // &lt;div&gt;Hello &amp; World&lt;/div&gt;
console.log("Unescaped HTML:", stringProcessor.unescapeHtml("&lt;div&gt;Hello &amp; World&lt;/div&gt;")); // <div>Hello & World</div>
console.log("Is Empty:", stringProcessor.isEmpty("")); // true
console.log("Kebab Case:", stringProcessor.kebabCase("Foo Bar Baz")); // foo-bar-baz
console.log("Padded Left:", stringProcessor.padLeft("abc", 5, '0')); // 00abc
console.log("Padded Right:", stringProcessor.padRight("abc", 5, '*')); // abc**
console.log("Snake Case:", stringProcessor.snakeCase("Foo Bar Baz")); // foo_bar_baz
console.log("Start Case:", stringProcessor.startCase("foo-bar-baz")); // Foo Bar Baz
console.log("Starts With '  H':", stringProcessor.startsWith(myText, '  H')); // true
console.log("Stripped HTML:", stringProcessor.stripHtml("<p>Hello <b>World</b></p>")); // Hello World
console.log("Stripped Punctuation:", stringProcessor.stripPunctuation("Hello, World! (123)")); // Hello World 123
console.log("Chars:", stringProcessor.chars("abc")); // ["a", "b", "c"]
console.log("Includes 'world':", stringProcessor.includes(myText, 'world')); // true
console.log("Lower Case:", stringProcessor.lowerCase(myText)); //   hello world, this is a test string with special characters!@#
console.log("Upper Case:", stringProcessor.upperCase(myText)); //   HELLO WORLD, THIS IS A TEST STRING WITH SPECIAL CHARACTERS!@#
console.log("Trimmed:", stringProcessor.trim(myText)); // Hello world, this is a TEST string with special characters!@#
console.log("Trimmed Left:", stringProcessor.trimLeft(myText)); // Hello world, this is a TEST string with special characters!@#
console.log("Trimmed Right:", stringProcessor.trimRight(myText)); //   Hello world, this is a TEST string with special characters!@#
